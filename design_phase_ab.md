...
VALUES ('2818', strftime('%s', 'now') * 1000, NULL, strftime('%s', 'now') * 1000);
```
...
// Request
{
  "poker_name": "ryo",
  "private_pass": "hunter2",
  "group_key": "2818"      // ログイン時も毎回 group_key を要求 (退会者の継続利用を防止)
}
// Response 200
...
6. ✅ テスト君 (poker_name=テスト君, private_pass=test, group_key=2818) でログイン可
