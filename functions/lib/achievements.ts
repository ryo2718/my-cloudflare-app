...
export async function evaluateAchievements(
  ...
  tryUnlock('fish_flop_srp_limp_blind', best('srp_limp_blind') >= 16); // Blind=10問/20pt
  tryUnlock('fish_flop_3bp_4bp_5bp_non_blind', best('3bp_4bp_5bp_non_blind') >= 32);
  tryUnlock('fish_flop_3bp_4bp_5bp_blind', best('3bp_4bp_5bp_blind') >= 16); // Blind=10問/20pt
  ...
  tryUnlock('shark_flop_srp_limp_blind', best('srp_limp_blind') >= 20); // Blind=10問/20pt
  tryUnlock('shark_flop_3bp_4bp_5bp_non_blind', best('3bp_4bp_5bp_non_blind') >= 40);
  tryUnlock('shark_flop_3bp_4bp_5bp_blind', best('3bp_4bp_5bp_blind') >= 20); // Blind=10問/20pt
