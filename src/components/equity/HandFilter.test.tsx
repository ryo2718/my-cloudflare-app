...
// AdQd=フラッシュ / AsAc=ツーペア(AA+JJ) / AhQh・Th9c=ワンペア(JJ)。役は3つ: フラッシュ/ツーペア/ワンペア。
...
describe('HandFilter (吹き出し式 内訳UI)', () => {
