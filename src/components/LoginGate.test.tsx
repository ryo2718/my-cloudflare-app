...
describe('<LoginGate /> 保存済みカードの肩書きバッジ', () => {
  // バッジは要素境界 (>ADMIN< 等) で判定 (group key ラベル "テスター/VIP は不要" との衝突回避)。
  it('admin / tester / VIP のバッジがそれぞれ表示される (VIP は残り日数付き)', () => {
  ...
  it('VIP 期限切れ (vip_until <= now) はバッジを表示しない', () => {
